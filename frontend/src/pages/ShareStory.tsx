...
/>
  ...
  <RatingPicker value={rating} onChange={setRating} />
            ...
            <div className="cs-row">
              ...
              <input className="cs-input" value={company} onChange={(e) => setCompany(e.target.value)} />
            </div>

            <div className="cs-row">
              <label className="cs-label">Country (optional)</label>
              <input className="cs-input" value={country} onChange={(e) => setCountry(e.target.value)} />
            </div>
